# Jently
[![Build Status](https://travis-ci.org/jwg2s/Jently.png?branch=develop)](https://travis-ci.org/jwg2s/Jently) [![Code Climate](https://codeclimate.com/github/jwg2s/Jently.png)](https://codeclimate.com/github/jwg2s/Jently)
